                            ...
                            <td>
                                ...
                                @if(auth()->user()->roles->contains(3))
                                    ...
                                    @else
                                        ...
                                        <a class="btn btn-xs btn-info text-white" v-on:click="apiCallOnClick('{{route('admin.p-to-approve-for-moderators.approve',['pid'=>$productForVendor->id,'a'=>true])}}')"  >
                                            Approve
                                        </a>
                                        <a class="btn btn-xs btn-danger text-white" v-on:click="apiCallOnClick('{{route('admin.p-to-approve-for-moderators.approve',['pid'=>$productForVendor->id,'a'=>false])}}')"  >
                                            Reject
                                        </a>
