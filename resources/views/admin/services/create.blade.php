...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="images">{{ trans('cruds.service.fields.images') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.images_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="videos">{{ trans('cruds.service.fields.videos') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.videos_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="sub_category_id">{{ trans('cruds.service.fields.sub_category') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.service.fields.sub_category_helper') }}</span>
            </div>
            <div class="form-group">
...
Dropzone.options.videosDropzone = {
    ...
    init: function () {
@if(isset($service) && $service->videos)
          var files =
            {!! json_encode($service->videos) !!}
              for (var i in files) {
              var file = files[i]
              this.options.addedfile.call(this, file)
              file.previewElement.classList.add('dz-complete')
