    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plans.update", [$plan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::MONTHLY_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('monthly_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="monthly_active_{{ $key }}" name="monthly_active" value="{{ $key }}" {{ old('monthly_active', $plan->monthly_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_cost') ? 'is-invalid' : '' }}" type="number" name="monthly_cost" id="monthly_cost" value="{{ old('monthly_cost', $plan->monthly_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::HALF_YEAR_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('half_year_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="half_year_active_{{ $key }}" name="half_year_active" value="{{ $key }}" {{ old('half_year_active', $plan->half_year_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('half_yearly_cost') ? 'is-invalid' : '' }}" type="number" name="half_yearly_cost" id="half_yearly_cost" value="{{ old('half_yearly_cost', $plan->half_yearly_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::YEARLY_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('yearly_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="yearly_active_{{ $key }}" name="yearly_active" value="{{ $key }}" {{ old('yearly_active', $plan->yearly_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yearly_cost') ? 'is-invalid' : '' }}" type="number" name="yearly_cost" id="yearly_cost" value="{{ old('yearly_cost', $plan->yearly_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::TWO_YEAR_BUNDLE_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('two_year_bundle_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="two_year_bundle_active_{{ $key }}" name="two_year_bundle_active" value="{{ $key }}" {{ old('two_year_bundle_active', $plan->two_year_bundle_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('two_year_bundle_cost') ? 'is-invalid' : '' }}" type="number" name="two_year_bundle_cost" id="two_year_bundle_cost" value="{{ old('two_year_bundle_cost', $plan->two_year_bundle_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::THREE_YEAR_BUNDLE_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('three_year_bundle_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="three_year_bundle_active_{{ $key }}" name="three_year_bundle_active" value="{{ $key }}" {{ old('three_year_bundle_active', $plan->three_year_bundle_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('three_year_bundle_cost') ? 'is-invalid' : '' }}" type="number" name="three_year_bundle_cost" id="three_year_bundle_cost" value="{{ old('three_year_bundle_cost', $plan->three_year_bundle_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Plan::LIFE_TIME_ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('life_time_active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="life_time_active_{{ $key }}" name="life_time_active" value="{{ $key }}" {{ old('life_time_active', $plan->life_time_active) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('life_time_cost') ? 'is-invalid' : '' }}" type="number" name="life_time_cost" id="life_time_cost" value="{{ old('life_time_cost', $plan->life_time_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}" type="number" name="currency" id="currency" value="{{ old('currency', $plan->currency) }}" step="1">
