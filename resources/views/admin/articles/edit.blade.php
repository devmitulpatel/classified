...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="title_long">{{ trans('cruds.article.fields.title_long') }}</label>
                <input class="form-control {{ $errors->has('title_long') ? 'is-invalid' : '' }}" type="text" name="title_long" id="title_long" value="{{ old('title_long', $article->title_long) }}">
                @if($errors->has('title_long'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title_long') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.article.fields.title_long_helper') }}</span>
            </div>
            <div class="form-group">
