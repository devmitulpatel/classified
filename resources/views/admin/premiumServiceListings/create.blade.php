...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.premiumServiceListing.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.premium-service-listings.store") }}" enctype="multipart/form-data">
            @csrf
