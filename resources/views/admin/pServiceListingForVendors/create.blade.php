...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pServiceListingForVendor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.p-service-listing-for-vendors.store") }}" enctype="multipart/form-data">
            @csrf
