...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.clientReview.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.client-reviews.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_post') ? 'is-invalid' : '' }}" type="text" name="job_post" id="job_post" value="{{ old('job_post', '') }}" required>
