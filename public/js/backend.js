...
/* harmony import */ var _components_partials_index_back__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/partials/index_back */ "./resources/js/components/partials/index_back.js");
...
window.MainViewApp = new Vue({
  ...
  methods: {
    apiCallOnClick: function apiCallOnClick() {
      ...
      var dataRefresh = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      // console.log(u);
      var th = this;
      axios.get(u).then(function (res) {
        var data = res.data;
        ...
        if (data.hasOwnProperty('ResponseMessage')) {
          ...
          if (_typeof(msg) == "object" || typeof msg == "array") {
...
/***/ "./resources/js/components/partials/index_back.js":
/*!********************************************************!*\
  !*** ./resources/js/components/partials/index_back.js ***!
  \********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _recent_product_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./recent_product_service */ "./resources/js/components/partials/recent_product_service.js");
/* harmony import */ var _recent_product_service__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_recent_product_service__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./resources/js/components/partials/recent_product_service.js":
/*!********************************************************************!*\
  !*** ./resources/js/components/partials/recent_product_service.js ***!
  \********************************************************************/
/*! no static exports found */
